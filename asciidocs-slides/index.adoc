...
* Der Koffer mit dem ma hoid des steuern konn und so

ifdef::backend-html5,backend-revealjs[image:system_architecture.png[width=100%]]

== Was ist?

=== 1. image:system_architecture.png[width=50%]
...
=== 2. image:system_architecture.png[width=50%]
...
=== 4. image:system_architecture.png[width=50%]
